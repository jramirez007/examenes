...
<style>
    ...
    /* align-items: center;     */
    height: 60vh;           /* Set the height to full viewport height */
                                ...
                                @foreach ($examenes as $obj)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{-- <a href="{{url('curso/reporte')}}/{{$obj->id}}?exportar=0" data-bs-toggle="modal" data-bs-target="#modalSetScore"
    ...
    <div class="modal fade" id="modalSetScore" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
