    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('catalogo/curso') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row gy-4">
                                ...
                                <div class="select-container">
                                    <select name="categoria_id" class="js-example-basic-multiple" required>
                                        ...
                                        @foreach ($categorias as $obj)
                                            <option value="{{ $obj->id }}"
                                                {{ old('categoria_id') == $obj->id ? 'selected' : '' }}>
                                                {{ $obj->nombre }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                ...
                                <textarea name="descripcion" value="{{ old('descripcion') }}" required class="form-control"
